...
import { CalnderService } from './calander-service.service';
...
@Component({
  ...
  styleUrl: './schedule-calander.component.scss'
})
export class ScheduleCalanderComponent {
  ...
  constructor(
    ...
    private appService: CalnderService,
